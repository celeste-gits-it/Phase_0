...
- using literal notation to assign the terah property to an empty object made me stumble. I wasn't sure about the syntax and had to read notes before proceeding.
- once I used {} it passed and everything else passed afterwards.
How difficult was it to add and delete properties outside of the object itself?
- delete is pretty straight forward as long as you call on the correct property delete works fine. 
What did you learn about manipulating objects in this challenge?
setting an object & property = another object & property is similar to hashes. 

Overall I enjoyed this challenge as I have most of the javascript challenges. I think the book eloquent Javascript is one of the best written books for beginner developers and I 
wish this would have been the first language we dove into as I seem to be grasping the concepts better than in Ruby.
*/
