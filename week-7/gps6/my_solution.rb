...
# I worked on this challenge [by myself, with: Jack Huang/Celeste Carter].
...
# Reflection - During the challenge I felt very confident doing release 1-8. Once it was time to refactor I (and my pair) found myself struggling a good bit because of the nesting. 
# When we started out we were using the index of the variables we were calling, but then we realized we were working with hashes and needed to put the actual name that calls on the key. 
# After that things were better. We both agreed this was a DRY as we could get it. 
